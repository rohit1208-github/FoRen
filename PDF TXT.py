...
Original file is located at
    https://colab.research.google.com/drive/19FQpyzr2hDegqZShuIIbrgFmTH9u2f_B
"""
...
documents = PyPDFLoader("/content/TXT to PDF conversion.pdf").load()
...
question = "Does Ajeeth want to go to India?"
